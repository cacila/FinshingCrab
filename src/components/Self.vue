<template>
	<div>
		...
		<div class="option">			
			...
			<button v-if="option === '' || option === '扑'" @click="Option">扑</button>
		</div>
		<div class="card">
...
const card = [
	...
	{ type: 3, value: 2, card: '♥Q', rank: 2 },
	{ type: 4, value: 2, card: '♦Q', rank: 2 },
	...
	{ type: 13, value: 0, card: '♠10', rank: 6 },
	{ type: 14, value: 0, card: '♣10', rank: 6 },
	{ type: 15, value: 4, card: '♠4', rank: 6 },
	{ type: 16, value: 4, card: '♣4', rank: 6 },
	{ type: 17, value: 1, card: '♥J', rank: 7 },
	{ type: 18, value: 1, card: '♦J', rank: 7 },
	{ type: 19, value: 7, card: '♥7', rank: 7 },
	{ type: 20, value: 7, card: '♦7', rank: 7 },
	{ type: 21, value: 0, card: '♥10', rank: 7 },
	{ type: 22, value: 0, card: '♦10', rank: 7 },
...
export default {
	props: ['No', 'before' ,'card'],
	data() {
		return {
			cardA: this.card ? card[this.card[0]].card : '',
			cardB: this.card ? card[this.card[1]].card : '',
			option: '' 
		}
	},
	methods: {
